<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    {{-- <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="GET" action="{{URL::full()}}">
            @csrf
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ route('listComment') }}">
                <i class="bi bi-layout-text-window-reverse"></i><span>Comment</span>
            </a>
        </li><!-- End Tables Nav -->
